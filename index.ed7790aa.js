...
})({"b0Da9":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "d2bf78a5ed7790aa";
"use strict";
...
},{}],"h0xsI":[function(require,module,exports) {
 ...
 */ const getChampionsIcons = async ()=>{
    await fetch("https://ddragon.leagueoflegends.com/cdn/13.18.1/data/es_ES/champion.json").then(function(result) {
        ...
        for(let championData in result.data){
            ...
            let champion = new (0, _championJsDefault.default)(data);
...
/**
    ...
    championsList.forEach((champion, index)=>{
        ...
        championImg.addEventListener("click", async ()=>{
            ...
            let skinUrl;
            if (skinIndex === 0) skinUrl = `https://ddragon.leagueoflegends.com/cdn/img/champion/loading/${champion.id}_0.jpg`;
            else skinUrl = `https://ddragon.leagueoflegends.com/cdn/img/champion/loading/${champion.id}_${skinIndex}.jpg`;
            const imageExists = await checkImageExists(skinUrl);
            if (imageExists) championImg.src = skinUrl;
            else {
                skinIndex = (skinIndex + 1) % (maxSkinPerChampion + 1);
                ...
                if (nextImageExists) championImg.src = nextSkinUrl;
            }
        });
    });
};
...
},{"./champion.js":"4Dd30","@parcel/transformer-js/src/esmodule-helpers.js":"hZ54O"}],"4Dd30":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["b0Da9","h0xsI"], "h0xsI", "parcelRequire94c2")

//# sourceMappingURL=index.ed7790aa.js.map
